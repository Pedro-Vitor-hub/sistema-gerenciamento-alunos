    ...
    public class Main {
        public static void main(String[] args) {
            ...
            gerenciarAlunos.cadastrar(new Aluno("Pedro", 25, 8.5));
            gerenciarAlunos.cadastrar(new Aluno("Lucas", 25, 8.5));
            gerenciarAlunos.cadastrar(new Aluno("Luana", 22, 10.0));

            System.out.println(gerenciarAlunos.listarPorNome());
        }
    }
